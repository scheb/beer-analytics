...
urlpatterns = [
    ...
    path(
        "styles/<str:category_slug>/charts/<str:chart_type>.<cformat:format>",
        style.category_chart,
        name="style_category_chart",
    ),
    ...
    path(
        "styles/<str:category_slug>/<str:slug>/charts/<str:chart_type>.<cformat:format>",
        style.chart,
        name="style_chart",
    ),
    ...
    path(
        "fermentables/<str:category_id>/<str:slug>/charts/<str:chart_type>.<cformat:format>",
        fermentable.chart,
        name="fermentable_chart",
    ),
    path(
        "fermentables/<str:category_id>/<str:slug>/recipes/random.json", fermentable.recipes, name="fermentable_recipes"
    ),
