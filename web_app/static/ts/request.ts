...
export function request(
    ...
    queryParams: any = {},
    body: any = null,
    onResponse: CallableFunction = function() {},
    ...
    xhr.onload = evt => {
        onResponse(parseXHRResult(xhr))
    }

    xhr.onerror = evt => {
        onResponse(errorResponse(xhr, 'Failed to make request.'))
    }

    xhr.ontimeout = evt => {
        onResponse(errorResponse(xhr, 'Request took longer than expected.'))
    }
...
export function getRequest(
    ...
    return request('get', url, queryParams, null, onResponse, options)
}
