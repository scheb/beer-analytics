...
from recipe_db.etl.format.parser import (
    FormatParser,
    ParserResult,
    float_or_none,
    int_or_none,
...
class BeerSmithParser(FormatParser):
    ...
    FERMENTABLE_FORM_MAP = [
        RecipeFermentable.GRAIN,
        RecipeFermentable.EXTRACT,
        RecipeFermentable.SUGAR,
        RecipeFermentable.ADJUNCT,
        RecipeFermentable.DRY_EXTRACT,
    ]
